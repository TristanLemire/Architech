 ...
 */
final class Version20210719143649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, incident_id INT DEFAULT NULL, datetime DATETIME NOT NULL, company VARCHAR(50) NOT NULL, mail VARCHAR(100) DEFAULT NULL, phone VARCHAR(10) DEFAULT NULL, UNIQUE INDEX UNIQ_D11814AB59E53FB9 (incident_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
